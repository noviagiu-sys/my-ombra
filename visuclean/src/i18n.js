...
const DE = {
  ...
  cameraStarting: "Kamera wird gestartet…", cameraWaiting: "Warte auf Kamerabild…",
  cameraLive: "Livebild", cameraZoom: "Kamerazoom", cameraTorch: "Kameralicht",
  cameraTorchOn: "Licht einschalten", cameraTorchOff: "Licht ausschalten", cameraSaving: "Foto wird übernommen…",
  cameraSettingFailed: "Die Kamera hat die Einstellung nicht bestätigt. Angezeigt wird der gemeldete Zustand.",
  cameraDetailHint: "Oberfläche scharf stellen, ruhig halten und Lichtwinkel verändern. Direkte Spiegelungen vermeiden.",
...
const EN = {
  ...
  cameraStarting: "Starting camera…", cameraWaiting: "Waiting for camera image…",
  cameraLive: "Live image", cameraZoom: "Camera zoom", cameraTorch: "Camera light",
  cameraTorchOn: "Turn light on", cameraTorchOff: "Turn light off", cameraSaving: "Capturing photo…",
  cameraSettingFailed: "The camera did not confirm this setting. The reported state is displayed.",
  cameraDetailHint: "Focus on the surface, hold steady and vary the lighting angle. Avoid direct reflections.",
